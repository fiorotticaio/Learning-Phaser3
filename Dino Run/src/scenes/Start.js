...
export default class Start extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('dinoRun', './src/sprites/images/spritesheet.png', { 
            frameWidth: 460,
            frameHeight: 410
        });
        this.load.image('menu', './src/sprites/images/menu.png');

        this.load.audio('music', './src/sprites/audio/Happy walk.mp3');
    }
    ...
    create() {
        ...
        this.dino = this.add.sprite(width / 2, height / 2, 'dinoRun').setScale(0.4);
        this.anims.create({
            key: 'run',
